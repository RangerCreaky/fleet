...
export default function NoticesPage() {
  return <PageShell eyebrow="Legal" title="Third-party notices" intro="Fleet is proprietary software built with open-source components whose licences remain in effect.">
    <Updated />
